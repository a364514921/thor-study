...
public class RedirectOutputStream {
    public static void main(String[] args) {
        try {
            ...
            PrintStream psErr = new PrintStream("./errLog.txt");// 创建文件输出流
            System.setOut(psErr);// 设置使用新的输出流
            System.out.println("警告：年龄变量成功定义，初始值为18");

            System.out.println("警告：性别变量成功定义，初始值为女");
            // 整合两个变量
            System.setOut(out);// 恢复原有输出流
